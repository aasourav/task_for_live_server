...
export default function SectionMerge(){
    ...
    const dataSend = async()=>{
        ...
        const res= await axios.post('https://taskbackend.vercel.app/reg',{
    ...
    const tryToLogin = async()=>{
        ...
        const res= await axios.post('https://taskbackend.vercel.app/login',{
            username,password
        })
        return res.data
    }
...
const logOut = async(e)=>{
    try{
        await axios.post('https://taskbackend.vercel.app/logout',{},{
            withCredentials:true
        })
        setLogged(false)
    }
...
const handleAddSubmit = async(e)=>{
    ...
    setData({})
    try{
            const res = await axios.post('https://taskbackend.vercel.app/tasks/add',{
...
const GetData = async()=>{
    try{
        const res = await axios.get('https://taskbackend.vercel.app/tasks/',{
        withCredentials:true
         })
        return res
    }
...
const handleEditSubmit = async(e)=>{
    ...
    try{
        const res = await axios.put(`https://taskbackend.vercel.app/tasks/edit/${e.target.name}`,{
            taskname,
            taskdes,
            created,
            status,
...
const handleComplete = async(e)=>{
    ...
    try{
        const res = await axios.put(`https://taskbackend.vercel.app/tasks/edit/${e.target.id}`,{
            taskname,
            taskdes,
            status:!status,
            created
...
const handleDelete = async(e) =>{
    ...
    setETasks([...Tdata])
    try{
        const res = await axios.delete(`https://taskbackend.vercel.app/tasks/${e.target.id}`,
        {
            withCredentials:true
        })
